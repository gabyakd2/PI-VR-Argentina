        ...
        <Row>
          <Col md={6} >
            ...
            <p className={style.priceCardCat}>
              Precio: <span className={style.numberPrice}>130.000 ARS</span>
            </p>
      ...
      <Container className={style.containerCard}>
        <Row>
          <Col md={6} >
            ...
            <p className={style.priceCardCat}>
              Precio: <span className={style.numberPrice}>120000 ARS</span>
            </p>
            <div className="d-flex">
              <p className={style.textCardCat}>Incluye:</p>
              <ul>
      ...
      <Container className={style.containerCard}>
        <Row>
          <Col md={6} >
            ...
            <p className={style.priceCardCat}>
              Precio: <span className={style.numberPrice}>115000 ARS</span>
            </p>
            <div className="d-flex">
              <p className={style.textCardCat}>Incluye:</p>
              <ul>
      ...
      <Container className={style.containerCard}>
        <Row>
          <Col md={6} >
            ...
            <p className={style.priceCardCat}>
              Precio: <span className={style.numberPrice}>108000 ARS</span>
            </p>
            <div className="d-flex">
              <p className={style.textCardCat}>Incluye:</p>
              <ul>
