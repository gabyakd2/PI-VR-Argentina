        ...
        <div className="container-sm mt-5 bg-dark" id="divContenedor">
          ...
          <div className="contenedorSeg">
            ...
            <p className="parrafoHome">
              ...
              quieta pero el cuerpo se levanta. Otro caso en donde se puede ver
              una mejoría es el estar acostado.
            </p>
            <h3 className="h3Faqs">
              - Mi internet no es muy bueno ¿Funcionará igual?
            </h3>
            <p className="parrafoHome">
              No requieren buena conexión a internet en sí sino estar dentro de
              la cobertura del router. Si tienes buena señal basta.
            </p>
            ...
            <p className="parrafoHome">
              ...
              podremos saber con exactitud ya que esto depende de la empresa de
              transportes.
            </p>
            <h3 className="h3Faqs">- ¿Incluyen baterías?</h3>
            <p className="parrafoHome">
              Si incluyen baterías recargables dentro de cada aparato, estas son
              recargadas con una entrada micro usb y también pueden ser
              reemplazadas.
            </p>
          </div>
        </div>
